...
exports.createBar = async function (req, res, next) {
    ...
    var args = [BarLocation,BarSerialNumber,Purity,BarRefiner,BarHallmarkVerfied,BarWeightInGms];
...
exports.createBuy = async function (req, res, next) {		                  
    ...
    var BarCostPostLbma    =  req.body.barCostPostLbma;        
    var TotalToFund        =  req.body.totalToFund;        
    var TotalWeight        =  req.body.totalWeight;         
    var BarSerialNumber    =  req.body.barSerialNumber; 
    var BarIds             =  req.body.barIds;             
	var AccountNo          =  req.body.accountNo;              
    var UserId             =  req.body.userId;       
  

    var args = [OrderId,BarCostPostLbma,TotalToFund,TotalWeight,BarSerialNumber,BarIds,AccountNo,UserId];
...
exports.createSell = async function (req, res, next) {		                  
    ...
    var args = [OrderId,BarIds,TotalWeight,TotalToFund,UserId];
...
exports.createSend = async function (req, res, next) {		                  
    ...
    var args = [OrderId,BarIds,TotalWeight,SenderUserId,ReceiverUserId];
